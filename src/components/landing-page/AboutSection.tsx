  ...
  >
    ...
    >
      ...
      <p className="text-right absolute [width:35%] [top:10%] [right:20px] [font-family:h2-font] [font-size:calc(0.1rem_+_1vw)]">
        UWB: Saves the World! is an annual hackathon teaching students computer
        science while preparing them for tech and business careers through
        hands-on learning and professional networking. Learn more here!
      </p>
    ...
    >
      ...
      <p className="text-left absolute [width:60%] [bottom:calc(1%_+_0.75vw)] [left:40px] [font-family:h2-font] [font-size:calc(0.1rem_+_1vw)]">
        UWB ACM is a chapter of the Association of Computing Machinery at UWB
        dedicated to creating events and providing insight into academics,
        research, and careers related to Computer Science. Learn more here.
      </p>
  ...
  return (
    ...
    >
      ...
      <svg
        ...
        height="100%"
      >
        <path d={path} fill="#00000000" stroke="black" strokeWidth="3" />
      </svg>
    </div>
  );
};
