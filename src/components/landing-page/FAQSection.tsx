...
const FAQSection = () => {
    return (
        <div className="bg-white border-black border-2 p-10 sm:mt-[10rem]">
            <h2 className="font-h1 text-5xl md:text-7xl text-[#49B2F8] text-center mb-[2rem]">
                FAQ
            </h2>
            ...
            <p className="ml-4 md:pl-12 font-h3 text-sm md:text-base leading-6">
                ...
                with this year’s theme: Save the World You will have access to
                mentors, workshops, and networking opportunities to help bring
                your ideas to life.
            </p>
            ...
            <p className="ml-4 md:pl-12 font-h3 text-sm md:text-base leading-6">
                No! UWB Hacks 2025 is open to students from any university and
            ...
            <p className="ml-4 md:pl-12 font-h3 text-sm md:text-base leading-6">
                Yes. If you don’t have a team, we will provide opportunities to
                form teams before the hackathon begins. Each team must have 3 to
                5 members—no exceptions. Teams that don’t meet this requirement
