...
const faqItems = [
    ...
    },
    {
        ...
        answer: "No prior programming experience is required! We welcome participants of all skill levels and will provide workshops, mentorship, and other learning opportunities.",
    },
    {
        question:
