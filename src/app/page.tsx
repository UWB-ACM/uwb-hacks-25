...
export default function Page() {
  ...
  return (
    <div className="flex flex-col items-center w-[screen] overflow-hidden">
      ...
      >
        <Image src={ScrollImage || "/placeholder.svg"} className="w-full" alt="Scroll to the top" />
      </button>

      <ParallaxProvider>
        <div id="main" ref={mainRef} className="w-full min-h-[100vh] bg-blue flex flex-col relative overflow-hidden">
          ...
          <Parallax speed={-30} className="absolute w-full h-full z-[-3] bottom-[40px] overflow-hidden">
            <Image
          ...
          <Parallax speed={-5} className="absolute w-full h-full z-[-1] bottom-[0] overflow-hidden">
            <Image
        ...
        <div
          ...
          style={{
            background: "linear-gradient(180deg, rgba(198,61,23,1) 0%, rgba(255,230,162,1) 100%)",
          }}
        >
        ...
        <div id="team" ref={meetTheTeamRef} className="w-full overflow-hidden">
          <MeetTheTeamSection />
        </div>
