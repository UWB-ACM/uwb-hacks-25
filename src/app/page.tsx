...
export default function Page() {
  ...
  const scrollToTop = () => {
    if (lenis.current) {
      lenis.current.scrollTo(0, { duration: 1.5, easing: (t: number) => t });
    }
  };
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <ParallaxProvider>
        ...
        <div id="schedule" ref={scheduleRef} className=" h-screen" style={{}}>
          <ScheduleSection />
        </div>
        <div
          id="team"
        ...
        <div id="sponsors" ref={sponsorsRef} className=" h-screen" style={{}}>
          <SponsorsSection />
        </div>
