                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full mb-8">
                        <div className="bg-white border-2 border-black px-8 py-4 shadow-lg rounded-xl hover:shadow-2xl transition-shadow duration-300">
                            ...
                            <p className="font-h3 text-base leading-6 mt-4">
                                Sponsoring a workshop allows you to interact
                                with participants, share expertise, and provide
                                hands-on guidance. Whether it’s a technical deep
                                dive, a business case study, or an interactive
                                demo, your workshop will help shape the next
                        ...
                        <div className="bg-white border-2 border-black px-8 py-4 shadow-lg rounded-xl hover:shadow-2xl transition-shadow duration-300">
                            ...
                            <p className="font-h3 text-base leading-6 mt-4">
                                ...
                                have very few spots available for workshops.
                                Though, we still encourage you to reach out to
                                us if you are interested in sponsoring a
                                workshop. We will do our best to accommodate
                                your request.
                            </p>
                        </div>
                    </div>
