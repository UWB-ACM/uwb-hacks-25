                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full mb-8">
                        <div className="bg-white border-2 border-black px-8 py-4 shadow-lg rounded-xl hover:shadow-2xl transition-shadow duration-300">
                            ...
                            <p className="font-h3 text-base leading-6 mt-4">
                                We are seeking sponsors to support specific
                                tracks in our hackathon, such as business,
                                biotech, and entertainment. By sponsoring a
                                track, you provide participants with the
                                opportunity to tackle real-world challenges in
                                your industry while gaining exposure to fresh
                                ideas and talent.
                            </p>
                        </div>
                        ...
                        <div className="bg-white border-2 border-black px-8 py-4 shadow-lg rounded-xl hover:shadow-2xl transition-shadow duration-300">
                            ...
                            <p className="font-h3 text-base leading-6 mt-4">
                                Sponsoring a track allows your organization to
                                be at the forefront of innovation, mentor
                                emerging talent, and gain brand recognition
                                among passionate and skilled participants. Your
                                support will help shape the future of technology
