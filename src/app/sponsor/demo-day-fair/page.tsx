                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full mb-8">
                        <div className="bg-white border-2 border-black px-8 py-4 shadow-lg rounded-xl hover:shadow-2xl transition-shadow duration-300">
                            ...
                            <p className="font-h3 text-base leading-6 mt-4">
                                On the final day of the hackathon, we’ll host a
                                Demo Day alongside judging to connect students
                                with industry professionals. As a sponsor, you
                                will have direct access to find new talent.
                            </p>
                        </div>
                        ...
                        <div className="bg-white border-2 border-black px-8 py-4 shadow-lg rounded-xl hover:shadow-2xl transition-shadow duration-300">
                            ...
                            <p className="font-h3 text-base leading-6 mt-4">
                                Sponsoring the fair offers a prime opportunity
                                to connect with innovative talent at the
                                hackathon and delve into their exciting
                                projects—all it takes is having a few company
                                representatives on hand to spark meaningful
                                conversations.
                            </p>
                        </div>
                    </div>
